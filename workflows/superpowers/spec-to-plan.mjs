/**
 * workflows/spec-to-plan.mjs — deepseek 由 spec 产出分 task 的 TDD 计划,人在环改稿。
 *
...
export const meta = {
  description: "deepseek 读 spec 产出分 task 的实现计划,人在环改稿定稿",
  // inputs: { specText }
};
...
export async function run(ctx, input) {
  ...
  const planText = await reviseWithHuman(ctx, draft, { agent: "omp", model: MODEL });
  return { planText };
}
